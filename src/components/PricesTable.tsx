...
export default function PricesTable() {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-20 px-4 mb-16">
      ...
      <div className="bg-white w-full max-w-4xl rounded-3xl shadow-xl p-6 md:p-10 relative">
        {/* Tabs */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-right flex-1">
            ...
            <p className="text-lg text-gray-700 mt-2">قیمت ۱ گرم زعفران نگین</p>
          ...
          {/* Chart */}
          <div className="w-full md:w-1/2 h-40 md:h-48">
        ...
        {/* Bottom Info */}
        <div className="grid grid-cols-3 text-center border-t pt-6 mt-6">
          <div>
            <p className="text-red-500 font-bold flex items-center justify-center gap-1">
              ۲٫۵۲٪ <ArrowDown size={18} />
            </p>
            <span className="text-gray-500 text-sm">تغییرات</span>
          </div>
          ...
          <div>
            ...
            <span className="text-gray-500 text-sm">بالاترین قیمت</span>
          </div>
          ...
          <div>
            ...
            <span className="text-gray-500 text-sm">پایین‌ترین قیمت</span>
          </div>
        </div>
      </div>
    </div>
